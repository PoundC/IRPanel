        ...
        <div id="carousel-slider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="/lander/img/1.jpg" class="img-responsive" alt="">
                    <div class="carousel-caption">
                        <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.3s">
                            <h2><span>Clean & Modern Design</span></h2>
                        </div>
                ...
                <div class="item">
                    <img src="/lander/img/2.jpg" class="img-responsive" alt="">
                    <div class="carousel-caption">
                        ...
                        <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.6s">
                            <form class="form-inline">
                                ...
                                <div class="form-group">
                                    <button type="livedemo" name="subscribe" class="btn btn-primary btn-lg"
...
<section class="features bg-white" id="features">
        ...
        <h2 class="text-center" style="margin-top: 25px; padding-bottom: 35px;">
            Features
        </h2>
...
<section class="cta">
    <div class="">
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-12 text-lg-right text-center" style="margin-top: 10px;">
                <a class="cta_btn cta_btn-ghost" href="#">Register Account</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="row-slider">
                        ...
                        <div class="responsive-slider" data-spy="responsive-slider" data-autoplay="true">
                            <div class="slides" data-group="slides">
                                ...
                                <ul>
                                        ...
                                        <li><img alt="" class="img-responsive" src="/lander/img/9.jpg" width="100%"
                                                 height="350"/></li>
                                        <li><img alt="" class="img-responsive" src="/lander/img/10.jpg" width="100%"
                                                 height="350"/></li>
                                        <li><img alt="" class="img-responsive" src="/lander/img/11.jpg" width="100%"
                                                 height="350"/></li>
                    ...
                    <div class="col-lg-6 ">
                        <div class="company mar-left10">
                            <h4>Our Company has created 1928 morbi leo risus, porta ac consectetur ac,
                                <span>vestibulum </span> at eros.</h4>
                            <p>Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce dapibus,
                                tellus ac cursus etiam porta sem malesuada magna mollis euismod. commodo, Faccibus
                                mollis interdum. Morbi leo risus, porta ac, vestibulum at eros.
                                Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce
                                dapibus, tellus ac.</p>
                        </div>
        ...
        <div class="row">
            <div class="col-xs-12 hidden-sm col-md-5">
                ...
                <div class="about-left">
                    <center><img src="/lander/img/about/about.png" alt="" style="margin-top:15px;"></center>
                </div>
                ...
                <div class="about-right">
                    ...
                    <div class="about-right-boot">
                        <div class="about-right-wrapper">
                            ...
                            <p>Michael Knight a young loner on a crusa champion the cause of the innocent. The helpless.
                                powerless in a world of operate above the law.</p>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="align-center2">
                    <div class="testimonial pad-top40 pad-bot40 clearfix jeff1">
                        <h5>
                    ...
                    <div class="wow bounceIn">
                        <div class="wow rotateIn">
                            <div class="service-col">
                                ...
                                <h2><a href="#">Ready to Use Instantly</a></h2>
                                <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor
                                    aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat
                                    ipsum.</p>
                            </div>
...
<section class="team bg-white" id="team">
...
<section id="parallax1" class="section mar-bot20" data-stellar-background-ratio="0.5">
    <div class=" ">
        <div class="align-center2 pad-bot40 jeff1">
            ...
            <p class="color-white">Nullam id dolor id nibh ultricies vehicula ut id elit. Donec sed odio dui. Fusce
                dapibus, tellus ac cursus etiam porta sem malesuada magna mollis euismod. commodo, Faccibus mollis
                interdum. Morbi leo risus, porta ac, vestibulum at eros.Feugiat accumsan Suspendisse eget Duis faucibus
...
<section id="line-pricing" class="bg-white">
    <div class="pad-top50">
...
<!-- section works -->
<section id="section-works" class="section appear bg-white clearfix">
    <div class="">
                ...
                <div class="row">
                    <div class="portfolio-items isotopeWrapper clearfix" id="3">
                        ...
                        <article class="col-md-4 isotopeItem webdesign">
                            <div class="portfolio-item">
                                <div class="wow rotateInUpLeft" data-animation-delay="4.8s">
                                    <img src="/lander/img/portfolio/1.jpg" alt="welcome"/>
                                </div>
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <div class="wow bounceIn">
                                    <img src="/lander/img/portfolio/2.jpg" alt=""/>
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <div class="wow rotateInDownRight">
                                    <img src="/lander/img/portfolio/3.jpg" alt=""/>
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <div class="wow rotateInUpLeft">
                                    <img src="/lander/img/portfolio/4.jpg" alt=""/>
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <div class="wow bounceIn">
                                    <img src="/lander/img/portfolio/5.jpg" alt=""/>
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                        ...
                        <article class="col-md-4 isotopeItem webdesign">
                            <div class="portfolio-item">
                                <div class="wow rotateInDownRight">
                                    <img src="/lander/img/portfolio/6.jpg" alt=""/>
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <div class="wow rotateInUpLeft">
                                    <img src="/lander/img/portfolio/7.jpg" alt=""/>
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                        ...
                        <article class="col-md-4 isotopeItem photography">
                            <div class="portfolio-item">
                                <div class="wow bounceIn">
                                    <img src="/lander/img/portfolio/8.jpg" alt=""/>
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
                        ...
                        <article class="col-md-4 isotopeItem print">
                            <div class="portfolio-item">
                                <div class="wow rotateInDownRight">
                                    <img src="/lander/img/portfolio/9.jpg" alt=""/>
                                </div>
                                <div class="portfolio-desc align-center">
                                    <div class="folio-info">
...
<section id="parallax2" class="section parallax" data-stellar-background-ratio="0.5">
    <div class="align-center2 pad-bot30 jeff1">
