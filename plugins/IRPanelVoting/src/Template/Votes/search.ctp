    ...
    <div class="col-lg-11 col-lg-offset-0">
        ...
        <div class="box">
            <div class="box-header">
                <center><h3>Search IRC Votes</h3></center>
            </div>

            <div class="box-body">

                <?= $this->Form->create(null, ['url' => ['plugin' => 'IRPanelVoting', 'controller' => 'Votes', 'action' => 'search']]); ?>
                    ...
                    <?php foreach($results as $result): ?>
                        ...
                        <div class="row">
                            <div class="col-sm-10 col-sm-offset-1">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a href="/voting/votes/view/<?= $result->id ?>"><h3><?= h($result->name) ?></h3></a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
