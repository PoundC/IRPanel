<?php
namespace AdminLTE\Test\Fixture;

use Cake\TestSuite\Fixture\TestFixture;

/**
 * AdminLTEMenuNotificationsFixture
 */
class AdminLTEMenuNotificationsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'menu_group' => ['type' => 'string', 'length' => 32, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'menu_group' => 'Lorem ipsum dolor sit amet',
