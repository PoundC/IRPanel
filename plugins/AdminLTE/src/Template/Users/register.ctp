    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <div class="form-group has-feedback">
                <?php echo $this->Form->control('fullname', ['label' => false, 'type' => 'text', 'placeholder' =>
            ...
            <div class="form-group has-feedback">
                <?php echo $this->Form->control('email', ['label' => false, 'type' => 'email', 'placeholder' => 'Email',
                'class' => 'form-control']); ?>
            ...
            if (Configure::read('Users.Tos.required')) {
                echo $this->Form->control('tos', ['type' => 'checkbox', 'label' => __d('CakeDC/Users', 'Accept TOS
